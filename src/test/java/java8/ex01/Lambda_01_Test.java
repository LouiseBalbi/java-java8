...
public class Lambda_01_Test {
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate filtrage2 = p -> p.getFirstname().equals("first_10");
        
        List<Person> result = filter(personList, filtrage2);
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate filtrage3 = p -> p.getAge() > 49 && DigestUtils.sha512Hex(p.getPassword()).equals(passwordSha512Hex);
        
        List<Person> result = filter(personList, filtrage3);
